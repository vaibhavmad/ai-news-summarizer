# AI News Summarizer
AI-powered automated news summarization pipeline using LLMs that fetches latest news articles, extracts key insights using an LLM, and delivers a concise summary via email.
...
Below is an example of the email summary generated by the system:

Generated summary for topic: "iPhone"
![Sample Email Output](assets/email_output.png)
